...
public class OrderApplicationServiceTest {
	...
	private final UUID CUSTOMER_ID = UUID.fromString("9a69edea-7c0a-4cc2-a9ef-1c964401197c");

	private final UUID RESTAURANT_ID = UUID.fromString("0761fe31-b954-45d9-963d-cacf7e3f4a54");

	private final UUID PRODUCT_ID = UUID.fromString("a7770307-ef15-4d3a-b174-26c4b1bf25d8");

	private final UUID ORDER_ID = UUID.fromString("1ab54f72-4326-4149-a252-03d7d50f0a21");
	...
	public void testCreateOrderWrongProductPrice() {
		OrderDomainException orderDomainException = Assertions.assertThrows(OrderDomainException.class, () -> {
			orderApplicationService.createOrder(createOrderCommandProductPrice);
		});
		Assertions.assertEquals(orderDomainException.getMessage(),
